...
public class DefaultSqlSessionFactoryBean
	...
	private String environment = DefaultSqlSessionFactoryBean.class.getSimpleName(); // EnvironmentAware
																						// requires
																						// spring
																						// 3.1
	...
	protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
		...
		logger.debug(
				"DefaultSqlSessionFactoryBean.buildSqlSessionFactory.typeAliasesPackage:" + this.typeAliasesPackage);
