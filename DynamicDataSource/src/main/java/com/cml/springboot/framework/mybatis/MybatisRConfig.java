...
public class MybatisRConfig {
	...
	public SqlSessionFactory sqlSessionFactory(@Qualifier("read") DataSource datasource,
			@Qualifier("mybatisConfigurationProperties2") MybatisConfigurationProperties properties) throws Exception {
	...
	@ConfigurationProperties(prefix = "db.mybatis2")
	@Component("mybatisConfigurationProperties2")
	...
	// @Component("dataSourceProperties2")
	// @ConfigurationProperties(prefix = "db.mybatis2.jdbc")
